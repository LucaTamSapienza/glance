...
"                           A GLANCE_SEMANTIC=1 build uses the on-device all-MiniLM-L6-v2\n"
"                           encoder, caching section vectors in DIR/.glance/ and fetching\n"
"                           the model to ~/.cache/glance on first use; else a hashing\n"
"                           embedder. Env: GLANCE_MINILM_MODEL/_NGL/_THREADS)\n"
